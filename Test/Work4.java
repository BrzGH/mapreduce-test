...
/**
 * 在article.txt中过滤掉sensitive.txt 包含的词，输出排除后的结果
 */
public class Work4 extends ToolRunner implements Tool {
  ...
  public static void main(String[] args) {
    try {
      System.exit(ToolRunner.run(new Configuration(),new Work4(),args));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
