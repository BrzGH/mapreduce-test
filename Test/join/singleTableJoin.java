...
public class singleTableJoin extends ToolRunner implements Tool{
  ...
  public int run(String[] args) throws Exception {
    ...
    //6、设置输入输出的参数
    FileInputFormat.setInputPaths(job,new Path("F:\\hdfs\\wordcount\\singleJoin"));

    FileOutputFormat.setOutputPath(job,new Path("F:\\hdfs\\wordcount\\singleJoinoutput"));
  ...
  public static void main(String[] args) {
    try {
      System.exit(ToolRunner.run(new Configuration(),new singleTableJoin(),args));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
